		  ...
		  in
		    {
		      ...
		      test = if builtins.length ( input-test-results.value ) != "list" then "${ builtins.concatStringsSep "," ( builtins.map builtins.typeOf input-test-results.value ) }" else "FAILED" ;
		      trace =
