		...
		to-string
		  ...
		  string =
		    ...
		    results : mapper : error :
			  ...
			  in builtins.trace ( builtins.concatStringsSep ";" [ ( builtins.concatStringsSep "," ( builtins.map builtins.typeOf results ) ) ( builtins.concatStringsSep "," ( builtins.map builtins.typeOf value ) ) ] { success = success ; value = value ; } ;
