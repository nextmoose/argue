		  ...
		  in
		    {
		      ...
		      test = if builtins.typeOf input-test-results == "set" then builtins.concatStringsSep "," ( builtins.attrValue ( builtins.mapAttr ( name : value : "${ name } is a ${ builtins.typeOf name } ) ) else "FAILED" ;
		      trace =
